...
public class DicomDialog extends JDialog {
	...
	public static void main(String[] args) {
		try {
			DicomDialog dialog = new DicomDialog();
	...
	public DicomDialog() {
		...
		getContentPane().setLayout(new BorderLayout());
		{
			...
			getContentPane().add(scrollPane, BorderLayout.CENTER);
			{
				...
				if (IndexOrthanc.dicomNode.size()>0){
					//On recupere le nombre d'AET disponible et leur noms
					String [] aetDispo=new String[IndexOrthanc.dicomNode.size()];
					IndexOrthanc.dicomNode.keySet().toArray(aetDispo);
