...
public class UserDialog extends JDialog {
	...
	public UserDialog() {
		...
		
		{
			...
			String[] utilisateurs=new String[IndexOrthanc.users.size()];
			IndexOrthanc.users.keySet().toArray(utilisateurs);
			for (int i=0; i<utilisateurs.length; i++){
				//On ajoute les ligne avec les valeurs
				model.addRow(new Object[]{utilisateurs[i].toString(),IndexOrthanc.users.get(utilisateurs[i]).toString()});
			}
		}
