...
public class PeersDialog extends JDialog {
	...
	public PeersDialog() {
		...
		
		{
			...
			String[] peerName=new String[IndexOrthanc.orthancPeer.size()];
			IndexOrthanc.orthancPeer.keySet().toArray(peerName);
			for (int i=0; i<IndexOrthanc.orthancPeer.size();i++){
				model.addRow(new String[] {"Name", "URL", "Login", "Password"});
				JSONArray peer=IndexOrthanc.orthancPeer.get(peerName[i]);
			...
			}
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						IndexOrthanc.orthancPeer.clear();
