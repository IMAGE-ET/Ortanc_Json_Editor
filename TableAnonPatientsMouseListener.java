...
public class TableAnonPatientsMouseListener extends MouseAdapter {
	...
	public TableAnonPatientsMouseListener(String[] parametresTableau, JTable tableau, TableDataAnonPatients modele, 
	...
	public void mousePressed(MouseEvent event) {
		...
		try {
			if(this.modele.getRowCount() != 0){
				...
				this.modeleAnonStudies.addStudies(parametresTableau,patientName, patientID, selectedUIDs);
			}
