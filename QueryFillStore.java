...
public class QueryFillStore {
	...
	public QueryFillStore(String[] parametresTableau){
		fullAddress=parametresTableau[0];
		authentication=parametresTableau[1];
		this.url=fullAddress+"/tools/find";
	}
	
	public QueryFillStore(String[] parametresTableau, String level, String inputType, String input, 
	...
	public void storeIDs() throws IOException{
		if(this.level.equals("Series")){
			this.url=fullAddress+"/studies/" + this.input;
			...
			this.url=fullAddress+"/patients/" + this.input;
			String studyResponse = this.sendQuery();
	...
	public String getStudyDescriptionAndUID(String orthancUID) throws IOException{
		this.url=fullAddress+"/studies/" + orthancUID;
		StringBuilder sb = new StringBuilder();
	...
	public Object[] getAET() throws IOException{
		this.url=fullAddress+"/modalities";
	...
	public void store(String aet, ArrayList<String> idList) throws IOException{
		...
		this.url=fullAddress+"/modalities/" + aet + "/store";
		this.sendQuery();
	}

	public Object[] getPeers() throws IOException{
		this.url=fullAddress+"/peers";
	...
	public void sendPeer(String peer, ArrayList<String> idList) throws IOException{
		...
		ids.replace(ids.length()-1, ids.length(), "]");
		this.toolboxListContent = ids.toString();
		this.url=fullAddress+"/peers/" + peer + "/store";
		this.sendQuery();
	}
