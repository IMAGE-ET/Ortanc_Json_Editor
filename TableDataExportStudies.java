...
public class TableDataExportStudies extends AbstractTableModel{
	...
	public TableDataExportStudies(String[] parametresTableau){
		super();
	...
	public void addStudy(String patientName, String patientID, String patientUID) throws IOException, ParseException{
		...
		QueryFillStore queryID = new QueryFillStore(parametresTableau, "Studies", null, patientUID, null, null);
		QueryFillStore queryDate = new QueryFillStore(parametresTableau, "Studies", null, patientUID, null, null);
		QueryFillStore queryDescription = new QueryFillStore(parametresTableau, "Studies", null, patientUID, null, null);
		QueryFillStore queryAccession = new QueryFillStore(parametresTableau, "Studies", null, patientUID, null, null);
		QueryFillStore queryStudyInstanceUID = new QueryFillStore(parametresTableau, "Studies", null, patientUID, null, null);
