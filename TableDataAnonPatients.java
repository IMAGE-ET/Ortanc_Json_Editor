...
public class TableDataAnonPatients extends AbstractTableModel{
	 ...
	 */
	public void addPatient(String[] parametresTableau, String patientName, String patientID, Date birthdate, ArrayList<String> selectedStudies) throws IOException, ParseException{
		QueryFillStore queryID = new QueryFillStore(parametresTableau,"Patients", patientName, null, null, null);
		String[] id = queryID.extractData("id").split("SEPARATOR");
		PatientAnon p = new PatientAnon(patientName, patientID, id[0], birthdate, selectedStudies);
