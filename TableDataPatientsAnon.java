...
public class TableDataPatientsAnon extends AbstractTableModel{
	...
	public TableDataPatientsAnon(String[] parametresTableau){
		super();
		//Set des settings
	...
	public void addPatient(String inputType, String input, String date, String studyDesc) throws IOException, ParseException{
		...
		QueryFillStore queryName = new QueryFillStore(parametresTableau, "Patients", inputType, input, date, studyDesc);
		QueryFillStore queryPatientID = new QueryFillStore(parametresTableau, "Patients", inputType, input, date, studyDesc);
		QueryFillStore queryID = new QueryFillStore(parametresTableau, "Patients", inputType, input, date, studyDesc);
		QueryFillStore queryBirthDate = new QueryFillStore(parametresTableau, "Patients", inputType, input, date, studyDesc);
