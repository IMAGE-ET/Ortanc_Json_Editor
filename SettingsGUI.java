...
public class SettingsGUI extends JFrame {
	...
	txtOrthanc.addFocusListener(new FocusAdapter() {
		...
		IndexOrthanc.orthancName=txtOrthanc.getText();
		}
	});
	...
	spinner_Max_Storage_Size.addFocusListener(new FocusAdapter() {
		...
		public void focusLost(FocusEvent e) {
			IndexOrthanc.MaximumStorageSize=(int) spinner_Max_Storage_Size.getValue();
		}
	});
	...
	spinner_Max_Patient_Count.addFocusListener(new FocusAdapter() {
		@Override
		public void focusLost(FocusEvent e) {
			IndexOrthanc.MaximumPatientCount=(int) spinner_Max_Patient_Count.getValue();
		}
	});
	...
	lua_value = new JLabel(String.valueOf(IndexOrthanc.luaFolder.size()));
	General_Strings.add(lua_value);
	
	JLabel lblNewLabel_9 = new JLabel("Plugins");
	General_Strings.add(lblNewLabel_9);
	
	plugin_value = new JLabel(String.valueOf(IndexOrthanc.pluginsFolder.size()));
	...
	textfield_Http_Port.addFocusListener(new FocusAdapter() {
		@Override
		public void focusLost(FocusEvent e) {
			IndexOrthanc.HttpPort=Integer.valueOf(textfield_Http_Port.getText());
		}
	});
	...
	textfield_Http_Port.setText(String.valueOf(IndexOrthanc.HttpPort));
	...
	textField_AET_Name.addFocusListener(new FocusAdapter() {
		@Override
		public void focusLost(FocusEvent e) {
			IndexOrthanc.DicomAet=textField_AET_Name.getText();
		}
	});
	...
	textField_AET_Port.addFocusListener(new FocusAdapter() {
		@Override
		public void focusLost(FocusEvent e) {
			IndexOrthanc.DicomPort=Integer.valueOf(textField_AET_Port.getText());
		}
	});
	...
	spinner_SCP_Timeout.addFocusListener(new FocusAdapter() {
		@Override
		public void focusLost(FocusEvent e) {
			IndexOrthanc.DicomScpTimeout=(int) spinner_SCP_Timeout.getValue();
		}
	});
	...
	chckbxDeflatedTs.addFocusListener(new FocusAdapter() {
		@Override
		public void focusLost(FocusEvent e) {
			IndexOrthanc.DeflatedTransferSyntaxAccepted=chckbxDeflatedTs.isSelected();
		}
	});
	...
	comboBox_Encoding.addFocusListener(new FocusAdapter() {
		@Override
		public void focusLost(FocusEvent e) {
			IndexOrthanc.DefaultEncoding=comboBox_Encoding.getSelectedItem().toString();
		}
	});
	...
	comboBox_Encoding.setSelectedItem(IndexOrthanc.DefaultEncoding);
	if (IndexOrthanc.DefaultEncoding==null) comboBox_Encoding.setSelectedIndex(0);
	...
	SSL_Certif_String.setText(IndexOrthanc.SslCertificate);
	...
	Login_pass_String = new JLabel(String.valueOf(IndexOrthanc.users.size()));
	...
	chckbx_Dicom_Always_Store.setSelected(IndexOrthanc.DicomAlwaysStore);
	chckbx_Dicom_Always_Store.addFocusListener(new FocusAdapter() {
		@Override
		public void focusLost(FocusEvent arg0) {
			IndexOrthanc.DicomAlwaysStore=chckbx_Dicom_Always_Store.isSelected();
		}
	});
	...
	chckbx_Check_Modality_Store.addFocusListener(new FocusAdapter() {
		@Override
		public void focusLost(FocusEvent e) {
			IndexOrthanc.CheckModalityHost=chckbx_Check_Modality_Store.isSelected();
		}
	});
	...
	spinner_Dicom_Scu_Timeout.addFocusListener(new FocusAdapter() {
		@Override
		public void focusLost(FocusEvent arg0) {
			IndexOrthanc.DicomScuTimeout=Integer.valueOf((spinner_Dicom_Scu_Timeout.getValue().toString()));
		}
	});
	spinner_Dicom_Scu_Timeout.setValue(IndexOrthanc.DicomScuTimeout);
	...
	textField_HTTP_Proxy.addFocusListener(new FocusAdapter() {
		@Override
		public void focusLost(FocusEvent arg0) {
			IndexOrthanc.HttpProxy=textField_HTTP_Proxy.toString();
		}
	});
	...
	btnHttpsCaCertificates.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent arg0) {
			...
			int ouvrir=fc.showOpenDialog(null);
			if (ouvrir==JFileChooser.APPROVE_OPTION) {
				IndexOrthanc.HttpsCACertificates=fc.getSelectedFile().toString();
				HTTPS_CA_Certificates.setText(IndexOrthanc.HttpsCACertificates);
			}
	...
	Dicom_Modalities_Number = new JLabel(String.valueOf(IndexOrthanc.dicomNode.size()));
	Network_Strings.add(Dicom_Modalities_Number);
	
	JLabel Orthanc_Peer = new JLabel("Orthanc Peer");
	Network_Strings.add(Orthanc_Peer);
	
	label_Peer_number = new JLabel(String.valueOf(IndexOrthanc.orthancPeer.size()));
	...
	btnUserContentType.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			Content_Dialog contentDialog=new Content_Dialog();
			contentDialog.setVisible(true);
			contentDialog.setAlwaysOnTop(true);
			Content_Type_Counter.setText(String.valueOf(IndexOrthanc.contentType.size()));
	...
	btnUserMetadata.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			Dialog_Metadata DialogMetadata=new Dialog_Metadata();
			DialogMetadata.setVisible(true);
			Metadata_Counter.setText(String.valueOf(IndexOrthanc.userMetadata.size()));
		}
	});
	...
	Content_Type_Counter = new JLabel(String.valueOf(IndexOrthanc.contentType.size()));
	Advanced_String.add(Content_Type_Counter);
	
	JLabel label_5 = new JLabel("Dictionnary");
	Advanced_String.add(label_5);
	
	Dictionnary_Counter = new JLabel(String.valueOf(IndexOrthanc.dictionary.size()));
	Advanced_String.add(Dictionnary_Counter);
	
	JLabel lblMetadata = new JLabel("Metadata");
	Advanced_String.add(lblMetadata);
	
	Metadata_Counter = new JLabel(String.valueOf(IndexOrthanc.userMetadata.size()));
